...
from acroface.models.densenet import DenseNetModelConfig, DenseNetModel
...
training_dataloader_config = DataloaderConfig(shuffle=True, drop_last=True, num_workers=6, persistent_workers=False)
dev_dataloader_config = DataloaderConfig(shuffle=False, num_workers=4, persistent_workers=False)

model_config = DenseNetModelConfig(trainer_config=trainer_config, 
                                   batch_size=32, 
                                   optim_class=AdamW, 
...
wrapper_config = ModelWrapperConfig(model_class=DenseNetModel, 
