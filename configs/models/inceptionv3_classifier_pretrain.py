...
from acroface.models.inception import InceptionModel, InceptionModelConfig
...
training_dataloader_config = DataloaderConfig(shuffle=True, num_workers=6, persistent_workers=False, drop_last=True)
dev_dataloader_config = DataloaderConfig(shuffle=False, num_workers=8, persistent_workers=False)

model_config = InceptionModelConfig(trainer_config=trainer_config, 
                                 batch_size=32, 
                                 optim_class=AdamW, 
...
wrapper_config = ModelWrapperConfig(model_class=InceptionModel, 
